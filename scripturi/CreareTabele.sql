...
ALTER TABLE masini ADD CONSTRAINT nr_inmatriculare_unique PRIMARY KEY ( index_proprietar );
...
ALTER TABLE locuri_de_parcare
    ADD CONSTRAINT masini_locuri_parcare FOREIGN KEY ( index_proprietar )
        REFERENCES masini ( index_proprietar );
