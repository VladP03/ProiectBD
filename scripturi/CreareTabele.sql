...
ALTER TABLE carti_de_identitate
    ADD CONSTRAINT cnp_check CHECK ( REGEXP_LIKE ( cnp,
                                                   '(1|2|5|6)[0-9][0-9](0|1)[0-9](0|1|2|3)[0-9](0|1|2|3|4|5)[0-9][0-9][0-9][0-9][0-9]' ) );

ALTER TABLE carti_de_identitate
    ADD CONSTRAINT serie_check CHECK ( REGEXP_LIKE ( serie,
                                                     '^[a-zA-Z .''-]+$' ) );

ALTER TABLE carti_de_identitate
    ADD CONSTRAINT numar_check CHECK ( REGEXP_LIKE ( numar,
...
ALTER TABLE carti_de_identitate
    ADD CONSTRAINT localitate_check CHECK ( REGEXP_LIKE ( localitate,
                                                          '^[a-zA-Z .''-]+$' ) );
...
ALTER TABLE locuri_de_parcare
    ADD CONSTRAINT durata_check CHECK ( durata IN ( 6, 12, 24 ) );
...
ALTER TABLE masini
    ADD CONSTRAINT marca_check CHECK ( REGEXP_LIKE ( marca,
                                                     '^[a-zA-Z .''-]+$' ) );

ALTER TABLE masini
    ADD CONSTRAINT nr_inmatriculare_check CHECK ( REGEXP_LIKE ( nr_inmatriculare,
...
ALTER TABLE masini
    ADD CONSTRAINT culoare_check CHECK ( REGEXP_LIKE ( culoare,
                                                       '^[a-zA-Z .''-]+$' ) );

ALTER TABLE masini
    ADD CONSTRAINT capacitate_motor_check CHECK ( capacitate_motor BETWEEN 0 AND 9999 );
...
ALTER TABLE plati
    ADD CONSTRAINT tip_plata_check CHECK ( tip IN ( 'card', 'numerar' ) );

ALTER TABLE plati
    ADD CONSTRAINT suma_check CHECK ( suma IN ( 500, 900, 1700 ) );
...
ALTER TABLE proprietari
    ADD CONSTRAINT nume_check CHECK ( REGEXP_LIKE ( nume,
                                                    '^[a-zA-Z .''-]+$' ) );

ALTER TABLE proprietari
    ADD CONSTRAINT prenume_check CHECK ( REGEXP_LIKE ( prenume,
                                                       '^[a-zA-Z .''-]+$' ) );

ALTER TABLE proprietari
    ADD CONSTRAINT telefon_check CHECK ( REGEXP_LIKE ( telefon,
                                                       '^0(2|7)\d{8}$' ) );

ALTER TABLE proprietari
    ADD CONSTRAINT email_check CHECK ( REGEXP_LIKE ( email,
...
ALTER TABLE strazi
    ADD CONSTRAINT denumire_check CHECK ( REGEXP_LIKE ( denumire,
                                                        '^[a-zA-Z .''-]+$' ) );

ALTER TABLE strazi
    ADD CONSTRAINT cartier_check CHECK ( REGEXP_LIKE ( cartier,
                                                       '^[a-zA-Z .''-]+$' ) );
...
CREATE OR REPLACE TRIGGER trg_masini_data_fabricare 
