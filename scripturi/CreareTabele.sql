...
ALTER TABLE masini
    ADD CONSTRAINT capacitate_motor_ck CHECK ( capacitate_motor BETWEEN 0 AND 9999 );
...
CREATE SEQUENCE locuri_de_parcare_seq START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER locuri_de_parcare_trg BEFORE
    INSERT ON locuri_de_parcare
    FOR EACH ROW
    WHEN ( new.index_loc_parcare IS NULL )
BEGIN
    :new.index_loc_parcare := locuri_de_parcare_seq.nextval;
END;
/
