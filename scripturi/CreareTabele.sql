...
ALTER TABLE detalii_masina ADD CONSTRAINT nr_inmatriculare_unique UNIQUE ( nr_inmatriculare );
...
ALTER TABLE modalitati_plata ADD CONSTRAINT modalitati_plata_pk PRIMARY KEY ( id_plata );
...
CREATE TABLE strazi (
    ...
    cartier            VARCHAR2(15) NOT NULL,
    nr_locuri_parcare  NUMBER(3) NOT NULL
);
...
ALTER TABLE strazi
    ADD CONSTRAINT cartier_ck CHECK ( REGEXP_LIKE ( denumire,
                                                    '^[a-zA-Z .''-]+$' ) );

ALTER TABLE strazi
    ADD CONSTRAINT strazi_nr_locuri_parcare_ck CHECK ( nr_locuri_parcare BETWEEN 0 AND 999 );
...
ALTER TABLE locuri_de_parcare
    ADD CONSTRAINT modalitati_plata_parcare FOREIGN KEY ( id_plata )
        REFERENCES modalitati_plata ( id_plata );

ALTER TABLE locuri_de_parcare
    ADD CONSTRAINT propietari_locuri_parcare_fk FOREIGN KEY ( index_proprietar )
        REFERENCES proprietari ( index_proprietar );

ALTER TABLE detalii_masina
    ADD CONSTRAINT propietari_masini_fk FOREIGN KEY ( index_proprietar )
        REFERENCES proprietari ( index_proprietar );
