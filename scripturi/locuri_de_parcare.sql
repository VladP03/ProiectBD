INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('31.03.2017', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('18.02.2018', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('11.04.2018', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('19.04.2018', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('29.07.2018', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('10.01.2019', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('15.03.2019', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('22.05.2019', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('07.07.2019', 'DD.MM.YYYY') )
);
...
INSERT INTO locuri_de_parcare(durata, data_inceput, data_expirare, index_proprietar, index_strada, id_plata) VALUES (
    ...
    (SELECT id_plata FROM modalitati_plata WHERE data_tranzactie = TO_DATE('31.03.2020', 'DD.MM.YYYY') )
);